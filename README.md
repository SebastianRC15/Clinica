...
Accede al panel de administración en http://localhost:8000/admin/ e inicia sesión con el superusuario creado.

Uso del Sistema
Administración de Clínicas
Accede al panel de administración
Crea una o más clínicas desde la sección "Clínicas"
Configuración de Ubicaciones (Ubigeo)
Crea ubicaciones geográficas (departamento, provincia, distrito) asociadas a cada clínica
Registro de Pacientes
Registra pacientes asociados a una clínica específica
Asigna la ubicación geográfica correspondiente al paciente
Gestión de Citas
Programa citas para los pacientes
Actualiza el estado de las citas según corresponda (programada, confirmada, atendida, cancelada)
